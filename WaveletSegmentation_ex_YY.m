...
n=1024
name='E:\Data\DNA-PAINT(Live-cell)\SPT_tracking\Basal_tracking\210507_newscFv-5xR1_test_HP_DIV16\1\Composite_SR_GluA1.tif'; %syn_16_20_3';% %gel270415_2_3_';%spots1_';%syn6_513_1024_';%iitgel1-1_';%syn_new_9_';%002cell_';% %somasekar1 (12)_';%syn_16_20_3_'; %dsc04575_';%b10nature_trees000_';%100_0109_';%gel1tiff_orig_';%image16_gauss35salt10_';%100_0109_40_3_';% 100_0109_';%image16_gauss40_';  %syn_16_40_3_';%
%Load image
I =imread(name); %syn_16_20_3.bmp'); %syn_new_9.bmp'); %gel270415_2_3.bmp');%spots1.bmp');%syn6_513_1024_.bmp'); %iitgel1-1.bmp');%002cell.png');%somasekar1 (12)1.tif');%007cell.png');%dsc04575.png');%b10nature_trees000.png');%gel1tiff_orig.tiff');%image16_gauss35salt10.bmp'); %image16_gauss40.bmp'); %syn_new_9.bmp'); %spatho1.bmp');%002cell.png');%syn_16_20_3.bmp'); %100_0109.png'); 
