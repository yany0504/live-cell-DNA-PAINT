...
%%%%%%%%%%%%%% revision
 save(strcat(userdirin,'result_tracking.mat'),'result_tracking');
%%%%%%%%%%%%%% revision
...
x=result_tracking(:,1);
y=result_tracking(:,2);
z=0.79*result_tracking(:,3); % 0.79 is the correction factor for RI mismatch for water/oil for an 1.40 NA objective
frame=result_tracking(:,4);
particle=result_tracking(:,5);
d=length(particle); % total row number
