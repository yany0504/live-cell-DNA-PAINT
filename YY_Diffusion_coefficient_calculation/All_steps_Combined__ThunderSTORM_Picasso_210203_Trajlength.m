...
path = 'E:\Data\AMPARtracking\210211_SPT-QD_scFv_intrabody_cLTP\';
outputpath='E:\Data\AMPARtracking\210211_SPT-QD_scFv_intrabody_cLTP\Results\';
pathsplit=strsplit(path,'\');
outputindex=pathsplit(end-1);
outputname='QD_mem3_good10_maxdisp500_k10_eps100'; % this will go to all the output filex e.g. result_tracking_picasso.txt
isitpicasso=0;
actualdimension=3;
% frame selection
