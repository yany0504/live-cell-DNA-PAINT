...
close all;% Close all figures
 ...
 path = 'E:\Data\DNA&FRET-PAINT(qPAINT)\200626_DNA-PAINT_HP\2\';
...
% % range for tracking YY 200628. If you want to track particle in specific
% range, use this part.
% mint=1
% maxt=4000;
% for i=1:length(positionlist)
%     if positionlist(i,4)<maxt+1
%         positionlist1(i,:)=positionlist(i,:);
%     else
%     end
% end
...
userdirin=path;
 ...
 DistBin=(0:0.02:2);
 figure; hist(cell2mat(TS_dist'),DistBin)
 xlim([0 1.98]);
