...
path = 'E:\Data\DNA-PAINT(Live-cell)\cLTP_counting\201130_livecellDNA-PAINT_STP\2\';
outputpath='E:\Data\DNA-PAINT(Live-cell)\cLTP_counting\201130_livecellDNA-PAINT_STP\2\Results\';
pathsplit=strsplit(path,'\');
outputindex=pathsplit(end-1);
outputname='2after003_mem3_good3_maxdisp500_k10_Eps500'; % this will go to all the output filex e.g. result_tracking_picasso.txt
isitpicasso=0;
% frame selection
...
cutoff=param.good; % in MSD calculation minimum length of trajectory
