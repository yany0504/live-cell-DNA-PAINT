...
path = 'E:\Data\DNA-PAINT(Live-cell)\SPT_tracking\vehicle_tracking\201228_livecell_DNA-PAINT_scFv-5xR1_Homer-mGeos_3D\9nt\1\';
outputpath='E:\Data\DNA-PAINT(Live-cell)\SPT_tracking\vehicle_tracking\201228_livecell_DNA-PAINT_scFv-5xR1_Homer-mGeos_3D\9nt\test_newcode_2020\';
pathsplit=strsplit(path,'\');
outputindex=pathsplit(end-1);
outputname='test1_mem3_good10_maxdisp500_difflength3'; % this will go to all the output filex e.g. result_tracking_picasso.txt
isitpicasso=0;
actualdimension=2;
% frame selection
...
diffusion_thres = 3; % how many time points used in calculating diffusion coefficients by linear fitting MSD
